					...
					<ul>
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Free On Oder Over ETB 100,000</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Safe your online payment and pays on Delivery</p>
							</div>
								...
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											...
											<li><a href="{{$setting->facebok}}" class="link-to-item" title="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2020 Abay Eccomerce All rights reserved</p>
					</div>
