              ...
              @if(Cart::instance('cart')->count() >0)        
					...
					<ul class="products-cart">
						...
						<li class="pr-cart-item">
							...
							@foreach($item->options as $key=>$value)
                               <div class="" style="vertical-align:middle;width=120px">
							     <p><b>{{$key}}:{{$value}}</b></p>       
							   </div>
							@endforeach
							<div class="price-field produtc-price"><p class="price">ETB {{$item->model->regular_price}}</p></div>
							<div class="quantity">
								...
								<p class="text-center"> <a href="#" wire:click.prevent="saveforLater('{{$item->rowId}}')">SaveForLater</a></p>
							</div>
							<div class="price-field sub-total"><p class="price">ETB {{$item->subtotal}}</p></div>
							<div class="delete">
				...
				<div class="summary">
					<div class="order-summary">
						...
						<p class="summary-info"><span class="title">Subtotal</span><b class="index">ETB {{Cart::instance('cart')->subtotal()}}</b></p>
						@if(Session::has('coupon'))
						<p class="summary-info"><span class="title">Discount ({{Session::get('coupon')['code']}})</span> <a href="#" wire:click.prevent="removeCoupon"><i  class="fa fa-times text-danger"></i> </a> <b class="index"> - ETB {{number_format($discount,2)}}</b></p>
						<p class="summary-info"><span class="title">Subtotal With Discount</span><b class="index">ETB {{number_format($subtotalAfterDiscount,2)}}</b></p>
						<p class="summary-info"><span class="title">Tax ({{config('cart.tax')}}%)</span><b class="index">ETB {{number_format($taxAfterDiscount,2)}}</b></p>
						<p class="summary-info total-info "><span class="title">Total</span><b class="index">ETB {{number_format($totalAfterDiscount,2)}}</b></p>
						@else
							<p class="summary-info"><span class="title">Tax</span><b class="index">ETB {{Cart::instance('cart')->tax()}}</b></p>
							<p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>
							<p class="summary-info total-info "><span class="title">Total</span><b class="index">ETB {{Cart::instance('cart')->total()}}</b></p>
						@endif
					</div>
				...
				<div class="wrap-iten-in-cart">
					...
					<ul class="products-cart">
						...
						<li class="pr-cart-item">
							...
							<div class="price-field sub-total"><p class="price">ETB {{$item->subtotal}}</p></div>
							<div class="delete">
								<a href="#" class="btn btn-delete" title="" wire:click.prevent="deleteItemInSavetolater('{{$item->rowId}}')">
					...
					@else
					<p> No item in the Save For Later</P>
					@endif
				</div>  
						...
						<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									...
									<div class="wrap-price"><span class="product-price">ETB  250.00</span></div>
								</div>
							</div>
							...
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									<a href="#" class="product-name"><span>Radiant-360 R6 Wireless Omnidirectional Speaker [White]</span></a>
									<div class="wrap-price"><ins><p class="product-price">ETB  168.00</p></ins> <del><p class="product-price">ETB  250.00</p></del></div>
								</div>
							</div>
