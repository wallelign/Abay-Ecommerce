              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">ETB {{$totalRevenu}}</span>
                  </div>   
                  <!-- <div class="col-xs-4 text-center">
                    <i class="fa fa-ETB  icon-stat-visual bg-primary"></i>
                  </div> -->
                </div>    
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value"> {{$totalSales}} Items</span>
                  </div>    
                  <div class="col-xs-4 text-center">
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">ETB {{$todayRevenu}}</span>
                  </div>    
                  <!-- <div class="col-xs-4 text-center">
                    <i class="fa fa-ETB  icon-stat-visual bg-primary"></i>
                  </div> -->
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">{{$todaySales}} Items</span>
                  </div>    
                  <div class="col-xs-4 text-center">
                    <i class="fa fa-gift icon-stat-visual bg-secondary"></i>
                  </div>
