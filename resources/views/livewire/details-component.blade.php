				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
							...
							@if($product->sale_price > 0 && $sales->sale_date > Carbon\Carbon::now() && $sales->status==1)
							<div class="wrap-price">
								<span class="product-price">ETB {{$product->sale_price}}</span>
								<del><span class="product-price regprice ">ETB {{$product->regular_price}}</span></del>
							</div>
							@else
							<div class="wrap-price"><span class="product-price">ETB {{$product->regular_price}}</span></div>
							@endif
							...
							<div>
                               @foreach($product->attributeValues->unique('product_attribute_id') as $av)
                                    <div class="row" style="margin-top:20px;">
										<div class="col-xs-2">
											<p>{{$av->productAttributes->name}}</p>
										</div>
										<div class="col-xs-10">
                                            <select class="form-control" style="width:200px" wire:model="sattr.{{$av->productAttributes->name}}">
												@foreach($av->productAttributes->attributeValues->where('product_id',$product->id) as $pav)
                            ...
                            <div class="quantity" style="margin:top=10px;">
								...
								<div class="quantity-input">
									...
									<a class="btn btn-reduce" href="#" wire:click.prevent="decrementDetail"></a>
									<a class="btn btn-increase" href="#" wire:click.prevent="increamentDetail"></a>
								</div>
							</div>
								...
								<li class="service">
									<a class="link-to-service" href="#">
										...
										<div class="right-content">
											...
											<span class="subtitle">On Oder Over  ETB 100,000</span>
											<p class="desc">Abay eccomerce will be one of the most ethiopian eccomerce amd it gives a free ship if customer shop more than above amount  </p>
										</div>
									</a>
								</li>
								...
								<li class="service">
									<a class="link-to-service" href="#">
										...
										<div class="right-content">
											...
											<p class="desc">Abay eccomerce will be one of the most ethiopian eccomerce and it gives an inspiration gift for their customers </p>
										</div>
									</a>
								</li>
								...
								<li class="service">
									<a class="link-to-service" href="#">
										...
										<div class="right-content">
											...
											<p class="desc">Abay eccomerce will be one of the most ethiopian eccomerce and the max day of return is 7 days  </p>
										</div>
									</a>
								</li>
							</ul>
								...
								<li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">ETB {{$p_product->regular_price}}</span></div>
										</div>
									</div>
								</li>
                                 @endforeach
							...
							<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
								...
								<div class="product product-style-2 equal-elem ">
									...
									<div class="product-info">
										...
										<div class="wrap-price"><span class="product-price">ETB {{$r_product->regular_price}}</span></div>
									</div>
								</div>
                               @endforeach
