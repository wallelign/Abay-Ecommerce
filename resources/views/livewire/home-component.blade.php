		...
		<div class="container">
			...
			<div class="wrap-main-slide">
				...
				<div class="item-slide">
						<img style="height:500px;" src="{{asset('assets/images/sliders') }}/{{$slide->image}}" alt="" class="img-slide">
						<div class="slide-info slide-1">
							<h2 class="f-title"><b>{{$slide->title}}</b></h2>
							<span class="subtitle">{{$slide->subtitle}}</span>
							<p class="sale-info">Only price: <span class="price">ETB{{$slide->price}}</span></p>
			...
			<!-- uplad file in home page -->
				<!-- <div  style="border:1px solid lightgrey;margin-top:17px;">
					<div class="text-center"style=" padding-top:8px; margin-left:130px; margin-top:40px;">
						<a href="/shop" class="btn btn-success" styl="margin-top:-14px;" >Upload-images</a>
						<h5 style="padding-bottom:16px;"> or upload product <span style="text-decoration:underline;">description</span> by clicking "upload-imges" button</h5>
					</div>
			  </div> -->
			...
			<!--On Sale-->
			@if($sproducts->count() > 0 && $sales->sale_date > Carbon\Carbon::now() && $sales->status==1)
			<div class="wrap-show-advance-info-box style-1 has-countdown">
				<h3 class="title-box">On Sale</h3>
				<div class="wrap-countdown mercado-countdown" data-expire="{{Carbon\Carbon::parse($sales->sale_date)->format('Y/m/d h:m:s')}}"></div>
				<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
					...
					<div class="product product-style-2 equal-elem ">
						...
						<div class="product-info">
							...
							<div class="wrap-price"><ins><p class="product-price">ETB{{$sproduct->sale_price}}</p></ins> <del><p class="product-price">{{$sproduct->regular_price}}</p></del></div>
						</div>
					</div>
					@endforeach
				</div>
                                  ...
                                  @foreach($lproducts as $lproduct)
									<div class="product product-style-2 equal-elem ">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">ETB {{$lproduct->regular_price}}</span></div>
										</div>
									</div>
                                  @endforeach
							     ...
							     @foreach($c_products as $c_product)
									<div class="product product-style-2 equal-elem ">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">ETB{{$c_product->regular_price}}</span></div>
										</div>
									</div>
									@endforeach
