              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">ETB {{$totalCost}}</span>
                  </div>   
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">{{$totalPurchase}} Items</span>
                  </div>    
                  <div class="col-xs-4 text-center">
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">{{$totalDelivered}} Items</span>
                  </div>    
                  <!-- <div class="col-xs-4 text-center">
                    <i class="fa fa-gift icon-stat-visual bg-secondary"></i>
                  </div> -->
              ...
              <div class="icon-stat">    
                <div class="row">
                  <div class="col-xs-8 text-left">
                    ...
                    <span class="icon-stat-value">{{$totalcanceled}} Items</span>
                  </div>    
                  <div class="col-xs-4 text-center">
                    <i class="fa fa-gift icon-stat-visual bg-secondary"></i>
                  </div>
