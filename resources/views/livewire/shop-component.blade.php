		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					<!-- <div style="padding:10px;margin-top:-50px"> upload file</div> -->
							...
							<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
								<div class="product product-style-3 equal-elem ">
									...
									<div class="product-info">
										<a href="{{route('product.details',['slug'=>$product->slug])}}" title="{{$product->name}}" class="product-name"><span>{{$product->name}}</span></a>
										...
										@else
										<a href="#" wire:click.prevent="productWishlist({{$product->id}},'{{$product->name}}',{{$product->regular_price}})"><i class="fa fa-heart"></i></a>
					 					@endif
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
					...
					<div class="widget mercado-widget filter-widget price-filter">
						<h2 class="widget-title">Price <span class="text-info">ETB {{$min_price}} - ETB {{$max_price}}</span></h2>
                          <div class="widget-content" style="10px 5px 40px 5px">
								...
								<li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">ETB 168.00</span></div>
										</div>
									</div>
								</li>
